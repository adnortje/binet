...
class ImageCodec:
    ...
    def __init__(self, img_dir, codec, img_size=(224, 320), progressive=True):
        ...
        # image codec
        if codec not in ['JPEG', 'WEBP', 'JPEG2000']:
    ...
    def load_cc(self, metric, save_dir='./image_codec/saved_cc'):
        ...
        if not os.path.isdir(save_dir):
            ...
            file_path = "".join(
                [save_dir, "/", self.codec, "_", metric, ".npy"]
            )
    ...
    def progressive_imshow(self, itrs, start_itr=0, widget=False):
        ...
        for b in np.arange(start_itr*0.125+0.125, itrs * 0.125 + 0.125, 0.125):
